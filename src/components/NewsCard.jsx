    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-black to-slate-800 p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        {news.map((item, index) => (
          ...
          <div
            key={index}
            className="bg-white/10  border border-white/10 rounded-3xl overflow-hidden shadow-2xl hover:scale-105 hover:shadow-cyan-500/30 transition-all duration-300"
          >
